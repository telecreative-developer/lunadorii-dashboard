...
import Loading from "components/lib/Loading.jsx"
import FormBanners from "components/Form/FormBanners.jsx"
...
class Reports extends Component {
  ...
  render() {
    if(this.state.loadMode){
      ...
      return(
        <FormBanners
          btnCancel={() => this.handleResetToAddMode()}
        />
      )
    }
    return (
      <div className="content">
        <Grid fluid>
          <Row>
            <Col md={12}>
            <button onClick={() => this.handleChangeToAddMode()}>Add Mode</button>
              <Card
                title="All Banners"
                  ...
                  <Table striped hover>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Active</td>
                        <td>
                          <button class="btn btn-warning" style={{marginLeft: 10, marginRight: 10}} onClick={() => this.handleChangeToEditMode()}>Edit</button>
